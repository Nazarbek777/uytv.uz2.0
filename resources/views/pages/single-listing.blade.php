...
<div class="featured_slick_gallery gray">
    <div class="featured_slick_gallery-slide">
        <div class="featured_slick_padd"><a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-1.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-1.jpg" class="img-fluid mx-auto" alt="" /></a></div>
        <div class="featured_slick_padd"><a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-2.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-2.jpg" class="img-fluid mx-auto" alt="" /></a></div>
        <div class="featured_slick_padd"><a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-3.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-3.jpg" class="img-fluid mx-auto" alt="" /></a></div>
        <div class="featured_slick_padd"><a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-4.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-4.jpg" class="img-fluid mx-auto" alt="" /></a></div>
    </div>
            ...
            <div class="col-lg-8 col-md-12 col-sm-12">
                ...
                <div class="property_block_wrap style-2 p-4">
                    <div class="prt-detail-title-desc">
                        <span class="label text-light bg-green">For Sale</span>
                        <h3>Jannat Graynight Mood In Siver Colony, London</h3>
                        <span><i class="bi bi-geo-alt"></i> 778 Country St. Panama City, FL</span>
                        <h3 class="prt-price-fix text-main">$7,600<sub>/month</sub></h3>
                        <div class="list-fx-features">
                            <div class="listing-card-info-icon">
                                <div class="inc-fleat-icon me-1"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/bed.svg" width="13" alt=""></div>3 Beds
                            </div>
                            <div class="listing-card-info-icon">
                                <div class="inc-fleat-icon me-1"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/bathtub.svg" width="13" alt=""></div>1 Bath
                            </div>
                            <div class="listing-card-info-icon">
                                <div class="inc-fleat-icon me-1"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/move.svg" width="13" alt=""></div>800 sqft
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div id="clFour" class="panel-collapse collapse">
                        <div class="block-body">
                            <div class="property_video">
                                <div class="thumb">
                                    <img class="pro_img img-fluid w100" src="https://shreethemes.net/resido-2.3/resido/assets/img/pl-6.jpg" alt="7.jpg">
                                    <div class="overlay_icon">
                                        <div class="bb-video-box">
                                            <div class="bb-video-box-inner">
                                                <div class="bb-video-box-innerup">
                                                    <a href="https://www.youtube.com/watch?v=A8EI6JaFbv4" data-bs-toggle="modal" data-bs-target="#popup-video" class="text-main"><i class="fa-solid fa-play"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="accordion" id="floor-option">
                                <div class="card">
                                    ...
                                    <div id="firstfloor" class="collapse" aria-labelledby="firstFloor" data-parent="#floor-option">
                                        <div class="card-body">
                                            <img src="https://shreethemes.net/resido-2.3/resido/assets/img/floor.jpg" class="img-fluid" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="card">
                    ...
                    <div id="clSev" class="panel-collapse collapse">
                        <div class="block-body">
                            <ul class="list-gallery-inline">
                                <li>
                                    <a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-1.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-1.jpg" class="img-fluid mx-auto" alt="" /></a>
                                </li>
                                <li>
                                    <a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-2.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-2.jpg" class="img-fluid mx-auto" alt="" /></a>
                                </li>
                                <li>
                                    <a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-3.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-3.jpg" class="img-fluid mx-auto" alt="" /></a>
                                </li>
                                <li>
                                    <a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-4.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-4.jpg" class="img-fluid mx-auto" alt="" /></a>
                                </li>
                                <li>
                                    <a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-5.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-5.jpg" class="img-fluid mx-auto" alt="" /></a>
                                </li>
                                <li>
                                    <a href="https://shreethemes.net/resido-2.3/resido/assets/img/p-6.jpg" class="mfp-gallery"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-6.jpg" class="img-fluid mx-auto" alt="" /></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div class="comment-list">
                                    <ul>
                                        <li class="article_comments_wrap">
                                            <article>
                                                <div class="article_comments_thumb">
                                                    <img src="https://shreethemes.net/resido-2.3/resido/assets/img/user-1.jpg" alt="">
                                                </div>
                                        ...
                                        <li class="article_comments_wrap">
                                            <article>
                                                <div class="article_comments_thumb">
                                                    <img src="https://shreethemes.net/resido-2.3/resido/assets/img/user-5.jpg" alt="">
                                                </div>
                                                <div class="comment-details">
                                                    <div class="comment-meta">
                                                        <div class="comment-left-meta">
                        ...
                        <div class="block-body">
                                ...
                                <div class="nearby_header">
                                    ...
                                    <div class="nearby_header_last">
                                        <div class="nearby_powerd">
                                            Powerd by <img src="https://shreethemes.net/resido-2.3/resido/assets/img/edu.png" class="img-fluid" alt="" />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="nearby-wrap">
                                <div class="nearby_header">
                                    ...
                                    <div class="nearby_header_last">
                                        <div class="nearby_powerd">
                                            Powerd by <img src="https://shreethemes.net/resido-2.3/resido/assets/img/food.png" class="img-fluid" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div class="neary_section_list">
                ...
                <div class="details-sidebar">
                    ...
                    <div class="sides-widget">
                        <div class="sides-widget-header bg-main">
                            <div class="agent-photo"><img src="https://shreethemes.net/resido-2.3/resido/assets/img/user-6.jpg" alt=""></div>
                        ...
                        <div class="sides-widget-body simple-form">
                            ...
                            <button class="btn btn-light-main fw-medium rounded full-width">Send Message</button>
                        </div>
                    </div>
                    ...
                    <div class="sides-widget">
                        ...
                        <div class="sides-widget-body simple-form">
                            ...
                            <button class="btn btn-light-main fw-medium rounded full-width">Calculate</button>
                        ...
                        <div class="sidebar_featured_property">
                            ...
                            <div class="sides_list_property">
                                <div class="sides_list_property_thumb">
                                    <img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-1.jpg" class="img-fluid" alt="">
                                </div>
                            ...
                            <div class="sides_list_property">
                                <div class="sides_list_property_thumb">
                                    <img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-4.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="sides_list_property_detail">
                            ...
                            <div class="sides_list_property">
                                <div class="sides_list_property_thumb">
                                    <img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-7.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="sides_list_property_detail">
                            ...
                            <div class="sides_list_property">
                                <div class="sides_list_property_thumb">
                                    <img src="https://shreethemes.net/resido-2.3/resido/assets/img/p-5.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="sides_list_property_detail">
