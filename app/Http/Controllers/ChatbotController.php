...
class ChatbotController
{
    ...
    public function chat(Request $request)
    {
        ...
        try {
            $propertiesIds = [];
            if (isset($response['properties']) && is_object($response['properties'])) {
                $propertiesIds = $response['properties']->pluck('id')->toArray();
            } elseif (isset($response['properties']) && is_array($response['properties'])) {
                $propertiesIds = array_column($response['properties'], 'id');
            }
            ...
            AiChatbotLog::create([
                ...
                'properties_suggested' => $propertiesIds,
            ...
            \Log::error('AI Chatbot Log yozish xatosi: ' . $e->getMessage());
        }
